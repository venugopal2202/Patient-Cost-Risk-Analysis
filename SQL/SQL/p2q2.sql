...
Q 0.2
Objective:
Identify patients who had more than 3 encounters in a year where each encounter had a total claim cost above a certain threshold 
(e.g., $10,000). The query should return the patient details, number of encounters, and the total cost for those encounters.*/
